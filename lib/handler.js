...
export async function handleMessage(sock, msg) {
    try {
        ...
        if (isGroup) {
            ...
            if (!canUseCommands) {
                // ✅ FIX: awali ilikuwa /^\.(ai|bot|photo)\s*/i — "." iliwekwa kwa nguvu
                // (hardcoded) badala ya kutumia prefix halisi kutoka config.js.
                // Sasa tunatumia ile ile prefixRegex iliyokwisha tengenezwa juu
                // (inayosoma pfx kutoka config), kisha tunaangalia jina la command
                // lililopatikana ni ai/bot/photo.
