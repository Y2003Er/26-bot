    ...
    if (fs.existsSync(commandsPath)) {
        ...
        for (const file of files) {
            try {
                ...
                // ── MPYA: iita onLoad() kwanza kama ipo — inafetch dynamic aliases ──
                ...
                if (module.name && typeof module.execute === 'function') {
                    ...
                    // ── MPYA: baada ya onLoad(), alias imejaa — sajili kila moja ──
                    if (Array.isArray(module.alias)) {
                        for (const a of module.alias) {
                            if (!a) continue;
                            const aKey = a.toLowerCase();
                            // Usiandike juu ya command iliyopo
...
// ════════════════
// 🛡️ ANTI-DELETE - Optimized for 1GB RAM
// ════════════════
