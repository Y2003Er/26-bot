...
// ════════════════════════════════════════════════════════════════
//   ✨ WELCOME — track DM mpya (in-memory)
// ════════════════════════════════════════════════════════════════
...
export async function handleMessage(sock, msg) {
    try {
        ...
        // ── DEBUG LOG ──
        console.log(`🔍 MSG: chat=${msg.key.remoteJid} | fromMe=${msg.key.fromMe}`);
        console.log(`🔍 TYPE:`, JSON.stringify(Object.keys(msg.message || {})));
        ...
        // ── AUTO WELCOME: DM mpya ya kwanza tu ──
        if (!isActualOwner && !seenDMs.has(senderJid)) {
            seenDMs.add(senderJid);
            ...
            const welcomeText =
                ...
                `╚══════════════════════════════╝\n\n` +
                `Habari yako! 😊\n` +
                `Nashukuri sana umefika hapa —\n` +
                `hii inamaanisha mengi kwangu! 🙏\n\n` +
                `━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
                `Sasa una chaguo la kuzungumza na:\n\n` +
                `👤 *MIMI BINAFSI*\n` +
                `   » Nitumie ujumbe tu bila kutag/mention\n` +
                `   » Nitakujibu haraka niwezavyo 😊\n\n` +
                `🤖 *BOT*\n` +
                `   » Reply kwenye ujumbe wowote wa bot\n` +
                `   » Au mention/tag bot moja kwa moja\n` +
                `      📌 .ai  |  .bot\n` +
                `   » Yuko online 24/7! ⚡\n\n` +
                `━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n` +
                `Chagua unavyotaka — tuko hapa kukusaidia! 💪`;
