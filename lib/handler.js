...
function isOwnerJid(jid) {
    ...
    // Futa @lid, @s.whatsapp.net, device suffix — baki namba tu
    const clean = j => String(j)
        .split(':')[0]
    ...
    // 1. Linganisha na OWNER_NUMBER kutoka .env (inaweza kuwa nyingi: 255xxx,255yyy)
    ...
    // 2. Linganisha na OWNER_LID kutoka .env (optional: 40304560349344,...)
    ...
    // 3. Linganisha na global.ownerLid (inawekwa na index.js wakati bot inaunganika)
