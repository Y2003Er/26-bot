...
const messageCache = new NodeCache({ stdTTL: 1800, checkperiod: 600, maxKeys: 100 });
...
export function setupAntiDelete(sock) {
    ...
    console.log('🛡️ Anti-Delete: ✅ Imewashwa (media inahifadhiwa mapema, max 4MB, retry kwa delay)');
}
